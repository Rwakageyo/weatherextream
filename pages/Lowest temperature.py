...
st.title("Lowest Minimum Temperature Records ")

st.markdown("The table below indicates the daily breaking records of minimum temperature recorded at different weather stations across the country. The records are based on the entire available data for each station from when it started operation. ")
...
st.header("Chart")
st.bar_chart(data1,x="Station", y="Value",use_container_width=True)
